...
# Install base
RUN apt-get update &&\
  apt-get install -y sudo locales curl g++ git vim libreadline-dev libpq-dev lsof bzip2 build-essential libssl-dev zlib1g-dev autoconf bison libyaml-dev libncurses-dev libffi-dev libgdbm6 libgdbm-dev && \
